...
class ToolsContainer extends React.Component {
    ...
    renderTool = (tool, i) => {
        ...
        return this.addTooltip(
            <Tool {...toolCfg} pluginCfg={tool.cfg} tooltip={tooltip} style={tool.style} btnSize={this.props.toolSize} bsStyle={this.props.toolStyle} key={tool.name || "tool" + i} mapType={this.props.mapType}
                {...tool.cfg} items={tool.items || []}>
                {tool.cfg && tool.cfg.glyph ? <Glyphicon glyph={tool.cfg.glyph}/> : tool.icon}{tool.text}
